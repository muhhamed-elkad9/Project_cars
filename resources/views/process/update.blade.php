                        ...
                        <form action="{{ route('process.update', $process->id) }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <select class="form-control" name="supplier_id" style="height: calc(2.8rem + 12px)"
                                        required>
                                        <option selected="true" value="{{ $process->supplier->id }}">
                                            {{ $process->supplier->name }}</option>
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-control" name="product_id" style="height: calc(2.8rem + 12px)"
                                        required>
                                        <option selected="true" value="{{ $process->product->id }}">
                                            {{ $process->product->product_name }}</option>
                                        <option disabled="disabled">--
                                            اختر الصنف --</option>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="counter_value" value="{{ $process->counter_value }}"
                                        class="form-control">
                                    @error('counter_id')
                                        <div class="alert
                                                alert-danger">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="price" value="{{ $process->price }}"
                                        class="form-control">
                                    @error('price')
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="date" name="processes_date" value="{{ $process->processes_date }}"
                                        class="form-control">

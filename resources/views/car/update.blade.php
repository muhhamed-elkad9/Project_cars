                        ...
                        <form action="{{ route('car.update', $cars->id) }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="car_name" value="{{ $cars->car_name }}"
                                        class="form-control">
                                    @error('car_name')
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="company_name_made"
                                        value="{{ $cars->company_name_made }}" class="form-control">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="date" name="car_year_buy" value="{{ $cars->car_year_buy }}"
                                        class="form-control">
                                    @error('car_year_buy')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="car_number" value="{{ $cars->car_number }}"
                                        class="form-control">
                                    @error('car_number')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="car_number_serial"
                                        value="{{ $cars->car_number_serial }}" class="form-control">
                                ...
                                <div class="col">
                                    ...
                                    <select id="car_year_made" name="car_year_made" class="form-control"
                                        ...
                                        <option selected="true" value="{{ $cars->id }}">{{ $cars->car_year_made }}
                                        </option>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" id="car_age" value="{{ $cars->car_age }}" name="car_age"
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="traveled_distance"
                                        value="{{ $cars->traveled_distance }}" class="form-control" readonly>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" id="car_value_buy" name="car_value_buy"
                                        value="{{ $cars->car_value_buy }}" class="form-control"
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="current_value" name="current_value"
                                        value="{{ $cars->current_value }}" class="form-control" readonly>
                                    @error('current_value')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
